...
from image_caption.third_party.CenterNet2.centernet.modeling.backbone.fpn_p5 import LastLevelP6P7_P5
from image_caption.third_party.CenterNet2.centernet.modeling.backbone.bifpn import BiFPN
